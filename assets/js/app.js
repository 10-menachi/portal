!function (t) {
    ...
    function s(e) {
        1 == t("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (t("html").removeAttr("dir"), t("#dark-mode-switch").prop("checked", !1), t("#rtl-mode-switch").prop("checked", !1), t("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css"), t("#app-style").attr("href", "assets/css/app.min.css"), document.body.setAttribute("data-bs-theme", "light"), "light" == document.body.getAttribute("data-bs-theme") && "light" == document.body.getAttribute("data-topbar") ? (document.body.setAttribute("data-topbar", "light"), a = !0) : "light" == document.body.getAttribute("data-bs-theme") && "dark" == document.body.getAttribute("data-topbar") ? document.body.setAttribute("data-topbar", "dark") : document.body.setAttribute("data-topbar", "light"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == t("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (t("html").removeAttr("dir"), t("#light-mode-switch").prop("checked", !1), t("#rtl-mode-switch").prop("checked", !1), t("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css"), t("#app-style").attr("href", "assets/css/app.min.css"), document.body.setAttribute("data-bs-theme", "dark"), document.body.setAttribute("data-topbar", "dark"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == t("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (t("#light-mode-switch").prop("checked", !1), t("#dark-mode-switch").prop("checked", !1), t("#bootstrap-style").attr("href", "assets/css/bootstrap-rtl.min.css"), t("#app-style").attr("href", "assets/css/app-rtl.min.css"), t("html").attr("dir", "rtl"), document.body.setAttribute("data-bs-theme", "light"), document.body.setAttribute("data-topbar", "light"), sessionStorage.setItem("is_visited", "rtl-mode-switch"))
    }
    ...
    if (t("#side-menu").metisMenu(), t("#vertical-menu-btn").on("click", function (e) {
    ...
    }), document.addEventListener("fullscreenchange", o), document.addEventListener("webkitfullscreenchange", o), document.addEventListener("mozfullscreenchange", o), t(".right-bar-toggle").on("click", function (e) {
        ...
        for (var r = document.getElementById("topnav-menu-content").getElementsByTagName("a"), c = 0, d = r.length; c < d; c++) r[c].onclick = function (e) {
    ...
    t(function () {
      ...
      //  s(e.target.id), 1 == (a = "light" == document.body.getAttribute("data-bs-theme") && "light" == document.body.getAttribute("data-topbar") ? !0 : a) && "light" == document.body.getAttribute("data-bs-theme") && document.body.setAttribute("data-topbar", "light")
