...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <?= form_open(admin_url('categories/update'), ['class' => 'themeForm']) ?>
                    <input type="hidden" name="term_id" value="{{ $object['term_id'] }}">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-3 mb-3">
                                <label class="mb-1">Title</label>
                                <input type="text" class="form-control postTitle" placeholder="Product name"
                                    name="postTitle" required="required" value="{{ $object['name'] }}">
                            </div>

                            <div class="col-md-3 mb-3">
                                <label class="mb-1">Name</label>
                                <input type="text" class="form-control postName" placeholder="Product Name"
                                    name="postName" required="required" value="{{ $object['slug'] }}">
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
